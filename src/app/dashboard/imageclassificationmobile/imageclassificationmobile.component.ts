...
@Component({
  selector: 'app-imageclassificationmobile',
  templateUrl: './imageclassificationmobile.component.html',
  styleUrls: ['./imageclassificationmobile.component.css']
})
export class IMAGECLASSIFICATIONMOBILEComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.loadExternalScript('../assets/js/sketch2.js');
