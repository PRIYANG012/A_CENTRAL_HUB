...
@Component({
  selector: 'app-soundclassification',
  templateUrl: './soundclassification.component.html',
  styleUrls: ['./soundclassification.component.css']
})
export class SoundclassificationComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.loadExternalScript('../assets/js/sketch4.js');
