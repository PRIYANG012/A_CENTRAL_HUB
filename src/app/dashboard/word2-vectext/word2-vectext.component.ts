...
@Component({
  selector: 'app-word2-vectext',
  templateUrl: './word2-vectext.component.html',
  styleUrls: ['./word2-vectext.component.css']
})
export class Word2VectextComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.loadExternalScript('../assets/js/sketch7.js');
